...
test.describe('Shopping Module — E2E', () => {
  ...
  test('shopping page loads with search bar and store filters', async ({ authenticatedPage: page }) => {
  ...
  test('wishlist and monitor buttons are visible', async ({ authenticatedPage: page }) => {
  ...
  test('coupon section is visible', async ({ authenticatedPage: page }) => {
